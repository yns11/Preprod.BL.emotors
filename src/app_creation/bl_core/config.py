...
def get_settings() -> Settings:
    ...
    # Archivage en lot : un PDF = jusqu'à `lot_max_pages` BL, analysés par
    # paquets de `lot_taille_ia` pages (un seul appel au modèle par paquet).
    # Un paquet plus large réduit le nombre d'appels mais allonge l'attente du
    # tout premier affichage : 3 à 6 est la plage utile.
    lot_max_pages = _int("BL_LOT_MAX_PAGES", 200, 1, 500)
    lot_taille_ia = _int("BL_LOT_TAILLE_IA", 4, 3, 6)
