...
VUES_ADMINISTRATION = {
    ...
    "Rapprochement vente": {ROLE_ADV: LECTURE, ROLE_FINANCE: LECTURE,
                            ROLE_ADMIN: MODIFICATION},
    # Archivage en lot : mêmes rôles que l'archivage unitaire de l'app
    # Création (APPROS côté achat, ADV côté vente).
    "Archivage réception": {ROLE_APPROS: MODIFICATION, ROLE_ADMIN: MODIFICATION},
    "Archivage expédition": {ROLE_ADV: MODIFICATION, ROLE_ADMIN: MODIFICATION},
