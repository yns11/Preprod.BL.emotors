...
def vue_archivage_lot(type_op: str) -> None:
    ...
    if etape == 2:
        ...
        # Part de l'image portée de 59 % à ~70 % de la largeur utile
        # (+18 % relatifs) : la relecture d'un BL se joue sur cette surface.
        ...
        with gauche:
            ...
            # Rapprochement identique à celui de l'app Création : le code
            # tiers prime sur la raison sociale.
            ...
            if detecte:
                if reconnu:
                    marque = "code ✓" if fiabilite == "code" else "nom ✓"
        ...
        with droite:
            # Visionneuse HTML : zoom +/-, ajustement et rotation se font côté
            # navigateur, donc SANS relancer le script — indispensable quand on
            # enchaîne les pages.
            ui.visionneuse_images(
                [pages_lot[index]],
                f"Page {index + 1} sur {total}", hauteur=760,
                etiquettes=[f"Page {index + 1} / {total} du PDF"],
