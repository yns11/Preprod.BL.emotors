...
- `src/app_creation` : parcours **terrain** (smartphone/tablette) en quatre
  étapes — un BL à la fois, plusieurs photos attachées comme pages, champs
  pré-remplis par IA. Publie une carte Teams à chaque **nouvelle réception**,
  en mentionnant les gestionnaires du portefeuille du fournisseur.
- `src/app_administration` : poste fixe — tableau de bord, **rapports
  d'activité PDF** (journalier, hebdo, mensuel, trimestriel, annuel),
  **archivage par lots** (PDF jusqu'à 200 pages, une page = un BL, relecture
  page par page avec pré-analyse IA anticipée), vues BL, DESADV, rapprochement
